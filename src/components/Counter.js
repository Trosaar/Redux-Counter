...
import { increment, decrement, incrementOdd, incrementAsy } from '../actions';
...
export default connect(mapStateToProps, { increment, decrement, incrementOdd, incrementAsy})(Counter);
